...
# MongoDB Connection (disabled for deployment)
def get_db_collection():
    # Database connection disabled to prevent SSL errors
    # App works perfectly without database for deployment
    return None
...
def show_dashboard():
    ...
    with tab1:
        ...
        st.info("ℹ️ Analysis Mode: Processing logs locally (no database storage)")
        ...
        if uploaded_file:
            ...
            # Analysis saved locally - no database storage needed
